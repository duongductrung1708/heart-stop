    ...
    <ModernArticle>
      ...
      <Section id="causes">
        ...
        <SubSection>
          ...
          <img src={cachhoisinhtimphoi} alt="Nhận biết dấu hiệu ngừng tim" style={{ width: '100%', borderRadius: '8px', margin: '1.5rem 0' }} />
        ...
        <SubSection>
          ...
          <StepCard>
            ...
            <img src={pic1} alt="Kỹ thuật ép tim" style={{ width: '100%', borderRadius: '8px', margin: '1.5rem 0' }} />
            <List>
              ...
              <img src={pic2} alt="Kỹ thuật ép tim" style={{ width: '100%', borderRadius: '8px', margin: '1.5rem 0' }} />
          ...
          <StepCard>
            ...
            <img src={pic3} alt="Kỹ thuật thổi ngạt" style={{ width: '100%', borderRadius: '8px', margin: '1.5rem 0' }} />
            <List>
              ...
              <img src={pic4} alt="Kỹ thuật thổi ngạt" style={{ width: '100%', borderRadius: '8px', margin: '1.5rem 0' }} />
      ...
      <Section id="steps">
        ...
        <img src={pic5} alt="Máy sốc tim tự động AED" style={{ width: '100%', borderRadius: '8px', margin: '1.5rem 0' }} />
        <List>
      ...
      <Section id="faq">
        ...
        <SubSection>
          ...
          <img src={pic6} alt="Poster truyền thông" style={{ width: '100%', borderRadius: '8px', margin: '1.5rem 0' }} />
        </SubSection>
